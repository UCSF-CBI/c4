...
Versions: <span class="module-version">4.0.0, 5.0.1, 6.1.1, 6.1.2, 7.0.0, 7.0.1, 7.1.0, 7.2.0, 8.0.1, 9.0.0, <em>9.0.1</em></span><br>
<details>
<summary>Module code: <a>view</a></summary>
<pre><code class="language-lua">help([[
...
Versions: <span class="module-version">0.7.1, <em>0.9.0</em></span><br>
<details>
<summary>Module code: <a>view</a></summary>
<pre><code class="language-lua">help([[
...
Warning: <span class="module-warning">Only the most recent version of this software will be kept.</span><br>
Versions: <span class="module-version">0.56.3, 0.59.0, <em>0.60.2</em></span><br>
<details>
<summary>Module code: <a>view</a></summary>
<pre><code class="language-lua">help([[
...
Warning: <span class="module-warning">Only the most recent version of this software will be kept.</span><br>
Versions: <span class="module-version">2.62.0, 2.63.0, 2.63.2, 2.66.1, <em>2.67.0</em></span><br>
<details>
<summary>Module code: <a>view</a></summary>
<pre><code class="language-lua">help([[
...
Versions: <span class="module-version">1.24.0, <em>1.24.4</em></span><br>
<details>
<summary>Module code: <a>view</a></summary>
<pre><code class="language-lua">help([[
...
-- /usr/share/lmod/lmod/libexec/sh_to_modulefile /software/c4/cbi/software/miniconda3-24.5.0-0-py312/etc/profile.d/conda.sh
pushenv(&quot;CONDA_EXE&quot;,&quot;/software/c4/cbi/software/miniconda3-24.5.0-0-py312/bin/conda&quot;)
pushenv(&quot;CONDA_PYTHON_EXE&quot;,&quot;/software/c4/cbi/software/miniconda3-24.5.0-0-py312/bin/python&quot;)
pushenv(&quot;CONDA_SHLVL&quot;,&quot;0&quot;)
prepend_path(&quot;PATH&quot;,&quot;/software/c4/cbi/software/miniconda3-24.5.0-0-py312/condabin&quot;)
pushenv(&quot;_CE_CONDA&quot;,&quot;&quot;)
pushenv(&quot;_CE_M&quot;,&quot;&quot;)
...
Warning: <span class="module-warning">Only the most recent version of this software will be kept.</span><br>
Versions: <span class="module-version">3.4, 3.5, 3.6, <em>3.6.3</em></span><br>
<details>
<summary>Module code: <a>view</a></summary>
<pre><code class="language-lua">help([[
...
Versions: <span class="module-version">2.00a3LM, 2.0.0-a.6.1, <em>2.0.0-a.6.4</em></span><br>
<details>
<summary>Module code: <a>view</a></summary>
<pre><code class="language-lua">help([[
...
Warning: <span class="module-warning">Only the most recent version of this software will be kept.</span><br>
Versions: <span class="module-version">1.3.361, 1.3.450, 1.4.549, 1.4.557, 1.5.57, 1.6.38, 1.6.39, 1.6.40, <em>1.6.42</em></span><br>
<details>
<summary>Module code: <a>view</a></summary>
<pre><code class="language-lua">help([[
...
Versions: <span class="module-version">4.0.5, 4.1.0, 4.1.3, 4.2.0-gcc13, 4.2.3-gcc13, 4.3.0-gcc13, 4.3.3-gcc13, 4.4.0-gcc13, 4.4.1-gcc13, 4.4.2-gcc13, <em>4.4.3-gcc13</em></span><br>
<details>
<summary>Module code: <a>view</a></summary>
<pre><code class="language-lua">help([[
...
Warning: <span class="module-warning">Only the most recent version of this software will be kept.</span><br>
Versions: <span class="module-version">1.68.2, 1.69.0, <em>1.69.1</em></span><br>
<details>
<summary>Module code: <a>view</a></summary>
...
Versions: <span class="module-version">2021.09.2-382, 2022.02.0-443, 2022.02.1-461, 2022.02.4-500, 2022.12.0-353, 2023.03.0-386, 2023.06.1-524, 2023.09.1-494, 2023.12.0-369, 2024.09.1-394, 2024.12.1-563, <em>2025.05.0-496</em></span><br>
<details>
<summary>Module code: <a>view</a></summary>
<pre><code class="language-lua">help([[
...
Versions: <span class="module-version">2.10.8, 2.10.9, 2.11.0, 2.11.1, 2.11.2, 2.11.3, 3.0.0, 3.0.1, 3.0.2, 3.0.5, 3.0.7, 3.1.0, 3.1.1, <em>3.2.0</em></span><br>
<details>
<summary>Module code: <a>view</a></summary>
<pre><code class="language-lua">help([[
...
<h3 id="module_cbi_wush" class="module-name">wush</h3>
<dl>
  <dd class="module-details">
<strong class="module-help">wush: Transfer Files Between Computers via Wireguard</strong><br>
<span class="module-description"><code>wush</code> is a command line tool that lets you easily transfer files and open shells over a peer-to-peer WireGuard connection. Main features are: (a) No requirement to set up or trust a relay server for authentication; (b) Powered by WireGuard for secure, fast, and reliable connections; (c) Automatic peer-to-peer connections over UDP; (d) Endless possibilities; <code>rsync</code>, <code>ssh</code>, etc.</span><br>
Example: <span class="module-example"><code>wush --help</code>, <code>wush serve</code>, and <code>wush cp local-file.txt</code>.</span><br>
URL: <span class="module-url"><a href="https://github.com/coder/wush">https://github.com/coder/wush</a>, <a href="https://github.com/coder/wush/releases">https://github.com/coder/wush/releases</a> (releases)</span><br>
Warning: <span class="module-warning">Only the most recent version of this software will be kept.</span><br>
Versions: <span class="module-version"><em>0.4.1</em></span><br>
<details>
<summary>Module code: <a>view</a></summary>
<pre><code class="language-lua">help([[
...
whatis(&quot;Version: &quot; .. version)
whatis(&quot;Keywords: utility, cli&quot;)
whatis(&quot;URL: https://github.com/coder/wush, https://github.com/coder/wush/releases (releases)&quot;)
whatis([[
Description: `wush` is a command line tool that lets you easily transfer files and open shells over a peer-to-peer WireGuard connection. Main features are: (a) No requirement to set up or trust a relay server for authentication; (b) Powered by WireGuard for secure, fast, and reliable connections; (c) Automatic peer-to-peer connections over UDP; (d) Endless possibilities; `rsync`, `ssh`, etc.
Examples: `wush --help`, `wush serve`, and `wush cp local-file.txt`.
Warning: Only the most recent version of this software will be kept.
]])
...
Warning: <span class="module-warning">Only the most recent version of this software will be kept.</span><br>
Versions: <span class="module-version">4.44.5, 4.44.6, <em>4.45.1</em></span><br>
<details>
<summary>Module code: <a>view</a></summary>
<pre><code class="language-lua">help([[
