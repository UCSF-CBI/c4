...
Mac users - for all the below instructions you will need to use `ssh -Y` secure x-forwarding. Unlike most Linux distros, macOS does not trust remote X servers by default.
