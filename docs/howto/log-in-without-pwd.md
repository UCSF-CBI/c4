...
<span>🛑</span> The public key you can safely share with the world, but **treat your <em>private key</em> as a password; anyone who has access to it will have access to your account if it does not have a passphrase!**
</div>
