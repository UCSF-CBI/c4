...
1. Your personal R package library. This is located under `~/R/`, e.g. `~/R/x86_64-pc-linux-gnu-library/4.2-CBI-gcc10/`

2. (optional) A site-wide R package library (not used on {{ site.cluster.name }})

3. The system-wide R package library part of the R installed, e.g. `{{ site.path.cbi_software }}/R-4.2.0-gcc10/lib64/R/library`
...
Warning in install.packages("zoo") :
  'lib = "{{ site.path.cbi_software }}/R-4.2.0-gcc10/lib64/R/library"' is not writable
...
** libs
gcc -I"{{ site.path.cbi_software }}/R-4.2.0-gcc10/lib/R/include" -DNDEBUG -I../inst/include  -I/usr/local/include   -fpic  -g -O2  -c coredata.c -o coredata.o
gcc -I"{{ site.path.cbi_software }}/R-4.2.0-gcc10/lib/R/include" -DNDEBUG -I../inst/include  -I/usr/local/include   -fpic  -g -O2  -c init.c -o init.o
gcc -I"{{ site.path.cbi_software }}/R-4.2.0-gcc10/lib/R/include" -DNDEBUG -I../inst/include  -I/usr/local/include   -fpic  -g -O2  -c lag.c -o lag.o
gcc -shared -L{{ site.path.cbi_software }}/R-4.2.0-gcc10/lib/R/lib -L/usr/local/lib -o zoo.so coredata.o init.o lag.o -L{{ site.path.cbi_software }}/R-4.2.0-gcc10/lib/R/lib -lR
...
Installing package into '{{ site.user.home }}R/x86_64-pc-linux-gnu-library/4.2-CBI-gcc10'
...
** using staged installation
** libs
gcc -I"{{ site.path.cbi_software }}/R-4.2.0-gcc10/lib/R/include" -DNDEBUG   -I/usr/local/include   -fpic  -g -O2  -c init.c -o init.o
gcc -I"{{ site.path.cbi_software }}/R-4.2.0-gcc10/lib/R/include" -DNDEBUG   -I/usr/local/include   -fpic  -g -O2  -c normexp.c -o normexp.o
gcc -I"{{ site.path.cbi_software }}/R-4.2.0-gcc10/lib/R/include" -DNDEBUG   -I/usr/local/include   -fpic  -g -O2  -c weighted_lowess.c -o weighted_lowess.o
gcc -shared -L{{ site.path.cbi_software }}/R-4.2.0-gcc10/lib/R/lib -L/usr/local/lib -o limma.so init.o normexp.o weighted_lowess.o -L{{ site.path.cbi_software }}/R-4.2.0-gcc10/lib/R/lib -lR
...
* removing '{{ site.user.home }}/R/x86_64-pc-linux-gnu-library/4.2-CBI-gcc10/sf'
* restoring previous '{{ site.user.home }}/R/x86_64-pc-linux-gnu-library/4.2-CBI-gcc10/sf'
```
...
Currently Loaded Modules:
  1) r/4.2.0   2) CBI   3) scl-devtoolset/11   4) gdal/2.4.4
...
Currently Loaded Modules:
  1) CBI   2) scl-devtoolset/11   3) r/4.2.0   4) mpi/openmpi-x86_64
...
** libs
gcc -I"{{ site.path.cbi_software }}/R-4.2.0-gcc10/lib64/R/include" -DNDEBUG -DPACKAGE_NAME=\"\" -DPACKAGE_TARNAME=\"\" -DPACKAGE_VERSION=\"\" -DPACKAGE_STRING=\"\" -DPACKAGE_BUGREPORT=\"\" -DPA
...
gcc -shared -L{{ site.path.cbi_software }}/R-4.2.0-gcc10/lib64/R/lib -L/usr/local/lib64 -o Rmpi.so Rmpi.o conversion.o internal.o -L/usr/lib64/openmpi/lib -lmpi -L{{ site.path.cbi_software }}/R-4.2.0-gcc10/lib64/R/lib -lR
installing to {{ site.user.home }}R/x86_64-pc-linux-gnu-library/4.2-CBI-gcc10/00LOCK-Rmpi/00new/Rmpi/libs
** R
** demo
** inst
** byte-compile and prepare package for lazy loading
