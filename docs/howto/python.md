...
Collecting HTSeq
  Using cached https://files.pythonhosted.org/packages/e4/23/aca490d5cf3265dc4b97907231ebb7a4c5b666b4df8eeb815328bef5178b/HTSeq-1.99.2.tar.gz
    ...
    ----------------------------------------
Command "python setup.py egg_info" failed with error code 1 in ~/pip-build-g6jyab7s/HTSeq/
```
...
Installing collected packages: six, zipp, importlib-resources, distlib, typing-extensions, importlib-metadata, filelock, platformdirs, virtualenv
...
created virtual environment CPython3.6.8.final.0-64 in 2273ms
